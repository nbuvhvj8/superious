...
const MOCK_SOURCES: Source[] = [
  {
    ...
    domain: 'nature.com',
    summary:
      'Comprehensive overview of CRISPR-based cancer therapies currently in clinical trials, covering CAR-T cell engineering approaches and early efficacy data from Phase 1 and 2 studies.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_142ca58b4-1771896405786.png',
  ...
  },
  {
    ...
    domain: 'science.org',
    summary:
      'The foundational 2012 Doudna-Charpentier paper establishing CRISPR-Cas9 as a programmable genome editing tool, covering molecular mechanism and initial experimental validation.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_151487bb0-1767590642596.png',
  ...
  },
  {
    ...
    domain: 'nejm.org',
    summary:
      'New England Journal of Medicine clinical trial results for Casgevy (exagamglogene autotemcel), reporting outcomes for 45 patients with severe sickle cell disease treated with CRISPR gene therapy.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_14799fecf-1775018426341.png',
  ...
  },
  {
    ...
    domain: 'statnews.com',
    summary:
      'STAT News coverage of the FDA approval of Casgevy in December 2023, including pricing analysis at $2.2 million per treatment and equity concerns around access for affected populations.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_12b48922a-1766323260826.png',
  ...
  },
  {
    ...
    domain: 'cancer.gov',
    summary:
      'NCI overview of ongoing CRISPR research programs in oncology, covering funded trials, mechanism of action in T-cell engineering, and the regulatory pathway for CRISPR-based cancer treatments.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_1fa90bf5e-1777123101595.png',
  ...
  },
  {
    ...
    domain: 'who.int',
    summary:
      'WHO 2021 recommendations on governance of human genome editing, calling for a global registry of germline editing research and mandatory international pre-approval before any clinical germline application.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_197888080-1769443513090.png',
  ...
  },
  {
    ...
    domain: 'bmj.com',
    summary:
      'BMJ systematic review of ethical frameworks proposed for CRISPR cancer therapies, covering consent requirements, equity in access, and the distinction between somatic and germline editing.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_1da386338-1767365955857.png',
  ...
  },
  {
    ...
    summary:
      'Lancet Oncology review of next-generation CRISPR variants — base editing and prime editing — covering reduced off-target effects, current clinical applications, and 5-year horizon for solid tumor treatment.',
    screenshotUrl:
      'https://img.rocket.new/generatedImages/rocket_gen_img_1a4ef1a27-1773250789316.png',
...
export default function SourcePanel({ highlightedSourceId, onSourceClick }: Props) {
  ...
  return (
    <div className="px-4 py-5 space-y-4">
      ...
      {/* Screenshot Modal */}
      {modalSource && (
        <Modal open={!!modalSource} onClose={() => setModalSource(null)} size="full">
    ...
    >
      ...
      {source.status === 'done' && (
        <p className="font-mono text-2xs text-muted-foreground">
          Captured{' '}
          {new Date(source.capturedAt).toLocaleTimeString('en-GB', {
            hour: '2-digit',
            minute: '2-digit',
            second: '2-digit',
          })}
